...
class AdvertisementViews(viewsets.ModelViewSet):
...
class AccountantsViews(viewsets.ModelViewSet):
...
class TendersViews(viewsets.ModelViewSet):
...
class NounsViews(viewsets.ModelViewSet):
